        ...
        <div class="header-wrapper rn-popup-mobile-menu m--0 row align-items-center">
            ...
            <div class="col-lg-2 col-6">
                <div class="header-left">
                    <div class="logo">
                        <a href="index.html">
                            {{-- <img src="{{ Storage::url($data[0]->photo) }}" alt="logo" width="60px" height="30px"> --}}
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-top">
                <div class="menu-header">
                    <a class="logo" href="index.html">
                        <img src="{{ Storage::url($data[0]->photo) }}" alt="Personal Portfolio">
                    </a>
                ...
                <div class="container">
                    <div class="row row--30 align-items-center">
                        <div class="order-2 order-lg-1 col-lg-7 mt_md--50 mt_sm--50 mt_lg--30">
                            <div class="content">
                                <div class="inner">
                                    ...
                                    <h1 class="title">Hi, I’m <span>{{$data[0]->name}}</span><br>
                                        ...
                                        <span class="cd-words-wrapper">
                                                    <b class="is-visible">{{$data[0]->titre_professionnel}}.</b>
                                    ...
                                    <div>
                                        <p class="description">{{$data[0]->biographie}}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6 col-12 mt_mobile--30">
                                        <div class="skill-share-inner">
                                            ...
                                            <ul>
                                                <li>mail address : <span style="font-weight: bolder">{{$data[0]->email}}</span></li>
                                                <li>Address: <span style="font-weight: bolder">{{$data[0]->adresse}}</span></li>
                                                <li>Number phone : <span style="font-weight: bolder">{{$data[0]->numberphone }}</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="order-1 order-lg-2 col-lg-5">
                            <div class="thumbnail">
                                <div class="inner">
                                    <img src="{{ Storage::url($data[0]->photo) }}" alt="Personal Portfolio Images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row row--25 mt_md--10 mt_sm--10">
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title">Job: <span style="color: #ff014f">{{$data[0]->metier}}</span>.</h4>
                                    <p class="description">Professional title: <span style="color: #ff014f">{{$data[0]->titre_professionnel}}</span>.</p>
                                    <p class="description">Current role: <span style="color: #ff014f">{{$data[0]->rôle_actuel}}</span>.</p>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><span style="color: #ff014f">Skills</span></h4>
                                    <p class="description" id="prog-lang">{{$data[0]->programming_languages}}</p>
                                    <!-- <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a> -->
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                <div class="content">
                                    <h4 class="title"><span style="color: #ff014f">Frameworks</span></h4>
                                    <p class="description" id="frameworks">{{$data[0]->frameworks}}</p>
                                    <!-- <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a> -->
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                <div class="content">
                                    <h4 class="title"><span style="color: #ff014f">Soft Skills</span></h4>
                                    <p class="description" id="soft-skills">{{$data[0]->soft_skills}}</p>
                                    <!-- <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a> -->
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                <div class="content">
                                    <h4 class="title"><span style="color: #ff014f">Languages</span></h4>
                                    <p class="description" id="lang">{{$data[0]->languages}}</p>
                                    <!-- <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a> -->
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                            ...
                            <div class="inner">
                                <div class="thumbnail" style="overflow: auto; height: 200px;">
                                    <a href="javascript:void(0)">
                                        <img src="{{ Storage::url($data[0]->project_image) }}"  style="height:156px;" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                        <div class="category-list">
                                            <a href="{{$data[0]->project_link}}">see the project<i class="feather-arrow-up-right"></i></a>
                                        </div>
                                    </div>
                                    <h4 class="title"><a href="#">{{$data[0]->project_title	}}</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div data-aos="fade-up" data-aos-delay="100" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                                            <div class="rn-portfolio" data-toggle="modal" data-target="#ee">
                                                <div class="inner">
                                                    <div class="thumbnail" style="overflow: auto; height: 200px;">
                                                        <a href="javascript:void(0)">
                                                            <img src="{{ asset('assets/images/portfolio/project-2.jpg') }}"  style="height:156px;" alt="Personal Portfolio Images">
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                                        <div class="category-info">
                                                            <div class="category-list">
                                                                <a href="javascript:void(0)">UI UX Design of Website <i class="feather-arrow-up-right"></i></a>
                                                            </div>
                                                            
                                                        </div>
                                                        <h4 class="title"><a href="javascript:void(0)">Design of Loan Landing Page </a></h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCente">
                            <div class="inner">
                                <div class="thumbnail" style="overflow: auto; height: 200px;">
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('assets/images/portfolio/xxx.jpeg') }}"  style="height:156px;"  alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                        <div class="category-list">
                                            <a href="javascript:void(0)">Portfolio Website <i class="feather-arrow-up-right"></i></a>
                                        </div>
                                       
                                    </div>
                                    <h4 class="title"><a href="javascript:void(0)">Design of Portfolio Website </a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCent">
                            <div class="inner">
                                <div class="thumbnail" style="overflow: auto; height: 200px;">
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('assets/images/portfolio/portfolio-03.jpg') }}"  style="height:156px;"  alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                        <div class="category-list">
                                            <a href="javascript:void(0)">Landing Page <i class="feather-arrow-up-right"></i></a>
                                        </div>
                                        
                                    </div>
                                    <h4 class="title"><a href="javascript:void(0)">IT Company Portfolio </a></h4>                     
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCen">
                            <div class="inner">
                                <div class="thumbnail" style="overflow: auto; height: 200px;">
                                    <a href="javascript:void(0)">
                                        <img src="{{ asset('assets/images/portfolio/portfolio-04.jpg') }}"  style="height:156px;"   alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                        <div class="category-list">
                                            <a href="javascript:void(0)">Figma <i class="feather-arrow-up-right"></i></a>
                                        </div>
                                    </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCe">
                            <div class="inner">
                                <div class="thumbnail" style="overflow: auto; height: 200px;">
                                    <a href="javascript:void(0)">
                                        <img src="{{ asset('assets/images/portfolio/portfolio-05.jpg') }}"  style="height:156px;"  alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                        <div class="category-list">
                                            <a href="javascript:void(0)">Web Design <i class="feather-arrow-up-right"></i></a>
                                        </div>
                                        
                                    </div>
                                    <h4 class="title"><a href="javascript:void(0)">Design for tecnology & services</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModal">
                            <div class="inner">
                                <div class="thumbnail" style="overflow: auto; height: 200px;">
                                    <a href="javascript:void(0)">
                                        <img src="{{ asset('assets/images/portfolio/portfolio-06.jpg')}} " style="height:156px;" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                    ...
                                    <h4 class="title"><a href="javascript:void(0)">App for tecnology & services</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="experience-list">
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4>{{$d->nom_diplomes}}</h4>

                                                                    <span>{{$d->nom_etablissement}}</span>
                                                                    
                                                                </div>
                                                                <div class="date-of-time">
                                                                    <span>{{$d->date_formation}}</span>
                                                                </div>
                    ...
                    <div class="col-lg-5">
                        <div class="contact-about-area">
                            ...
                            <div class="title-area">
                                ...
                                <span>{{$data[0]->metier}}</span>
                            </div>
                            <div class="description">
                                <p>I am available for freelance work. Connect with me via and call in to my account.
                                </p>
                                <span class="phone">Phone: <a href="#">{{$data[0]->numberphone}}</a></span>
                                <span class="mail">Email: <a href="inaamajay007@gmail.com">{{$data[0]->email}}</a></span>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-area text-center">                        
                        <p class="description mt--30">© 2024. All rights reserved by <a target="_blank"></a></p>
                    </div>
                </div>
            </div>
        </div>
